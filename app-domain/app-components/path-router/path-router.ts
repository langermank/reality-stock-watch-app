...
import {
  isPathRouteHandlerFunction,
  isPathRouteHandlerExecutionResult,
} from './path-route-default-handler';
...
export class PathRouter {
  ...
  constructor({
    defaultRouteHandler,
    defaultMissingRouteHandler,
    routeSeparator = defaultSeparator,
  }: Partial<PathRouterConstructorObjectType> = {}) {
  ...
  async executeRoute(
    ...
    try {
      const result = isPathRouteHandlerFunction(handler)
